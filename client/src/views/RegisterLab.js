            ...
            <div className="split-wrap invert-mobile invert-desktop">
              <div className="split-item">
                <div className="split-item-content center-content-mobile" style={{overflowY:"scroll",height:"28rem",overflowX:"hidden"}}>
                  ...
                  <p className="m-0">For Police Officer</p>
                  ...
                  <div className="mb-16">
                    ...
                    <input id="last_name" onChange={this.changeHandle} className="form-input white-text" type="text" placeholder="Last name"  />
                  </div>
                  <div className="mb-16">
                  ...
                  <div className="mb-16">
                    ...
                    <input type="text" onChange={this.changeHandle} id="contact" className="form-input white-text" placeholder="Contact Number" />
                  </div>
                  <div className="mb-16">
                    <label className="form-label" htmlFor="identity_no">Identity Card Number</label>
                    <input type="text" onChange={this.changeHandle} id="identity_no" className="form-input white-text" placeholder="Identity Card Number" />
                  </div>
                  <div className="mb-16">
